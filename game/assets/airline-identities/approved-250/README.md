...
The 118 previously mis-cropped existing marks were fully replaced (82 rebuilt as complete project-native emblems and 36 regenerated from clean standalone sources). 17 additional repeated marks were given distinct project-native artwork so every airline has a unique source mark. The remaining package marks retain their verified deterministic project-native artwork.
